"""
Mask R-CNN
Train on the toy cell dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 cell.py train --dataset=/home/datascience/Workspace/maskRcnn/Mask_RCNN-master/samples/cell/dataset --weights=coco
    ...
    python3 cell.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>
